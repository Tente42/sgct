                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ $setting->value }}"
                                       min="0"
                                       class="w-full pl-8 pr-4 py-2 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-lg font-semibold {{ Auth::user()->canEditRates() ? '' : 'bg-gray-100 cursor-not-allowed' }}"
                                       placeholder="0"
                                       {{ Auth::user()->canEditRates() ? '' : 'readonly' }}>
                            </div>
