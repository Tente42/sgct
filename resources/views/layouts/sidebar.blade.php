...
<aside class="w-64 bg-gray-800 text-white flex flex-col fixed inset-y-0 left-0 z-40" style="height: 100vh;">
    ...
    <nav class="flex-1 overflow-y-auto mt-4">
        <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
                <a href="{{ route('stats.kpi-turnos') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
