...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Configuración de Tarifas')); ?>
    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white shadow rounded-lg border-0">
            ...
            <form action="<?php echo e(route('settings.update')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gray-50 rounded-lg p-4 border">
                            <label for="<?php echo e($setting->key); ?>" class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       ...
                                       min="0"
                                       class="w-full pl-8 pr-4 py-2 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-lg font-semibold <?php echo e(Auth::user()->canEditRates() ? '' : 'bg-gray-100 cursor-not-allowed'); ?>"
                                       placeholder="0"
                                       <?php echo e(Auth::user()->canEditRates() ? '' : 'readonly'); ?>>
                            </div>
                ...
                <div class="mt-6 pt-4 border-t">
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-sm text-yellow-700">
                        ...
                        Solo los usuarios con permiso pueden modificar las tarifas.
                    </div>
                </div>
                <?php endif; ?>
            </form>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\panel_llamadas\resources\views/settings/index.blade.php ENDPATH**/ ?>