...
<?php $component->withAttributes([]); ?>
    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('cdr.charts')); ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded shadow-md transition">
            ...
            <div class="p-4">
                <form action="<?php echo e(url('/')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                    ...
                    <div class="md:col-span-2 flex gap-2 items-end">
                        ...
                        <a href="<?php echo e(route('calls.export', array_merge(request()->all(), ['fecha_inicio' => request('fecha_inicio', $fechaInicio), 'fecha_fin' => request('fecha_fin', $fechaFin)]))); ?>" class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded text-center">
