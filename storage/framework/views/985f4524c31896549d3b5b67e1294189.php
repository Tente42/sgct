...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Configuración Inicial de Central')); ?>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-8 text-white">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold"><?php echo e($pbx->name ?: 'Central PBX'); ?></h3>
                            <p class="text-blue-100"><?php echo e($pbx->ip); ?>:<?php echo e($pbx->port); ?></p>
                            <span class="inline-flex items-center gap-1 mt-2 px-3 py-1 rounded-full text-sm
                                <?php echo e($pbx->status === 'ready' ? 'bg-green-500/30 text-green-100' : ''); ?>

                                <?php echo e($pbx->status === 'syncing' ? 'bg-yellow-500/30 text-yellow-100' : ''); ?>

                                <?php echo e($pbx->status === 'pending' ? 'bg-gray-500/30 text-gray-100' : ''); ?>

                                <?php echo e($pbx->status === 'error' ? 'bg-red-500/30 text-red-100' : ''); ?>">
                                <i class="fas fa-circle text-xs"></i>
                                <?php echo e($pbx->getStatusDisplayName()); ?>
                ...
                <div class="p-6" x-data="syncManager()">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="bg-gray-50 rounded-lg p-4 text-center">
                            <div class="text-3xl font-bold text-gray-700" x-text="extensionCount"><?php echo e(number_format($extensionCount)); ?></div>
                            <div class="text-sm text-gray-500">Extensiones</div>
                        </div>
                        <div class="bg-gray-50 rounded-lg p-4 text-center">
                            <div class="text-3xl font-bold text-gray-700" x-text="callCount"><?php echo e(number_format($callCount)); ?></div>
                    ...
                    <div x-show="!isSyncing && status !== 'ready'" class="space-y-4">
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            <a href="<?php echo e(route('pbx.index')); ?>" 
    ...
    <script>
        function syncManager() {
            return {
                pbxId: <?php echo e($pbx->id); ?>,
                status: '<?php echo e($pbx->status); ?>',
                isSyncing: <?php echo e($pbx->isSyncing() ? 'true' : 'false'); ?>,
                ...
                lastMessage: '<?php echo e($pbx->sync_message); ?>',
                progress: 0,
                
                extensionCount: <?php echo e($extensionCount); ?>,
                callCount: <?php echo e($callCount); ?>,
                ...
                init() {
                    ...
                    if (this.status === 'ready') {
                        this.lastMessage = '<?php echo e($pbx->sync_message); ?>';
                    }
                },
                ...
                urls: {
                    syncExtensions: '<?php echo e(route("pbx.syncExtensions", $pbx->id)); ?>',
                    syncCalls: '<?php echo e(route("pbx.syncCalls", $pbx->id)); ?>',
                    finishSync: '<?php echo e(route("pbx.finishSync", $pbx->id)); ?>',
                    syncStatus: '<?php echo e(route("pbx.syncStatus", $pbx->id)); ?>'
                },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\panel_llamadas\resources\views/pbx/setup.blade.php ENDPATH**/ ?>